@extends('layouts.app')
@section('title', 'Privacy Policy - SmartLookBD')
@section('content')
<div class="max-w-4xl mx-auto px-4 py-16">
    ...
    <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 prose max-w-none text-gray-600 text-sm leading-relaxed space-y-6">
        <p>Your privacy is important to us. It is SmartLookBD's policy to respect your privacy regarding any information we may collect from you across our website, <a href="{{ route('home') }}" class="text-orange-500 font-medium">{{ config('app.url') }}</a>, and other sites we own and operate.</p>
