...
<div class="flex justify-between items-center mb-6">
    <h2 class="text-xl font-bold text-gray-900 dark:text-white">Hero Slider Banners</h2>
    <a href="{{ route('admin.banners.create') }}" class="admin-primary-btn px-4 py-2 rounded-lg text-sm font-semibold transition-colors shadow-sm">
        <i data-lucide="plus" class="w-4 h-4 mr-1 inline-block"></i> Add Hero Banner
    </a>
</div>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col group p-4 gap-4 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="relative w-full h-40 rounded-xl overflow-hidden bg-gray-100 dark:bg-gray-900 border-2 border-orange-100 dark:border-orange-900/30 group-hover:border-orange-500/50 transition-all duration-300 ring-4 ring-orange-50/50 dark:ring-orange-900/10">
            ...
            <div class="absolute top-2 right-2 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                <a href="{{ route('admin.banners.edit', $banner) }}" class="p-2 bg-white text-blue-600 rounded-lg shadow-md hover:bg-blue-50 dark:bg-gray-900 dark:text-blue-400 dark:hover:bg-gray-800">
        ...
        <div class="flex items-center justify-between text-sm">
            <div class="flex items-center gap-4">
                ...
                <div class="flex items-center gap-3 text-gray-500 dark:text-gray-400">
                    <i data-lucide="monitor" class="w-4 h-4 {{ $banner->show_on_desktop ? 'text-blue-500' : 'opacity-20' }}" title="Show on PC"></i>
                    <i data-lucide="smartphone" class="w-4 h-4 {{ $banner->show_on_mobile ? 'text-blue-500' : 'opacity-20' }}" title="Show on Mobile"></i>
                </div>
            </div>
        </div>
    </div>
