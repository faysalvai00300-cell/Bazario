                        ...
                        <div class="py-6 first:pt-0 last:pb-0 flex gap-5">
                            ...
                            <div class="flex-1 min-w-0 flex flex-col justify-center">
                                <div class="flex items-center gap-2 mb-1">
                                    <h4 class="font-bold text-gray-900 text-sm md:text-base truncate">{{ $item->product_name }}</h4>
                                    @if($item->product && $item->product->sku)
                                    <span class="text-[9px] bg-slate-50 text-slate-400 px-1.5 py-0.5 rounded font-bold uppercase tracking-widest">Product Code: <span class="text-orange-600">{{ $item->product->sku }}</span></span>
                                    @endif
                                </div>
